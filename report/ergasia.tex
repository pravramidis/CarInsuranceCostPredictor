...
%
%
\author{Όνοματεπώνυμο Συγγραφέα \and Όνοματεπώνυμο Συγγραφέα2}
%
%
%
\institute{{\bf Εξόρυξη Δεδομένων 2018-19}\\
Τμήμα Ηλεκτρολόγων Μηχανικών \& Μηχανικών Υπολογιστών\\
Πανεπιστήμιο Θεσσαλίας, Βόλος\\
\email{\{user1,user2\}@e-ce.uth.gr}}
...
%
\subsubsection{Τίτλος Υπο\"υποενότηταs}
%
We assume that $H$ is
...
\begin{figure}
\begin{center}
\includegraphics[width = 8cm]{Rplus-16-map.pdf}
\end{center}
\caption{This is the caption of the figure displaying important cities location.}
\end{figure}
