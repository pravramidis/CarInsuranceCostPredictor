...
Με τη βοήθεια διαγραμμάτων, καταφέραμε να επιλέξουμε τον κατάλληλο διαχωρισμό των δεδομένων για περαιτέρω ανάλυση. Στη συνέχεια, στην εργασία έχουμε προχωρήσει στη δημιουργία και 
αξιολόγηση των μοντέλων πρόβλεψης xgboost,RandomForest και ενός NeuralNetwork και στην οπτικοποίηση και αξιολόγηση των αποτελεσμάτων τους.
...
Αρχικά εκπαιδεύσαμε τα μοντέλα με όλους τους τύπους οχημάτων και ύστερα από παρατήρηση των αποτελεσμάτων , φαινόταν καλύτερη η επιλογή να εκπαιδεύσουμε τα μοντέλα με κάθε τύπο οχήματος ξεχωριστά. Όπως φαίνεται καθαρά και από την ενότητα 5 [Εικ. \ref{fig:subfigures4}] με τα διαγράμματα και τις παρατηρήσεις τους (Παρατήρηση 1).
...
Τα αριθμητικά χαρακτηριστικά και οι ενσωματώσεις των κατηγορικών χαρακτηριστικών συνδυάζονται σε ένα ενιαίο σύνολο εισόδων. Το νευρωνικό δίκτυο αποτελείται από πολλά πλήρως συνδεδεμένα στρώματα με διαφορετικό αριθμό μονάδων, μειώνοντας σταδιακά τους νευρώνες, ενώ χρησιμοποιείται στρώμα dropout για την τυχαία απενεργοποίηση ορισμένων νευρώνων, προλαμβάνοντας το overfitting.\\
% Τα δεδομένα περνούν από τα στρώματα με ενεργοποίηση ReLU και dropout. Το μοντέλο εκπαιδεύεται σε πολλούς κύκλους (epochs) σε παρτίδες (batch_size), όπου εκτελεί προώθηση (forward pass), υπολογίζει την Loss, και πραγματοποιεί οπισθοδρόμηση (backward pass) για την ενημέρωση των βαρών του μοντέλου. Μετά από κάθε κύκλο εκπαίδευσης, υπολογίζονται μετρήσεις απόδοσης όπως η Μέση Απόλυτη Απόκλιση (MAE) και το R-squared (R2).
\begin{table}[h!]
    \centering
    \begin{tabular}{l|cc}
        \hline
...
Αυτή η αποκλήση μπορεί να οφείλετε σε έλειψη πληροφορίας απο το δεδομένα μας αφού ενδέχετε 
...
Σχετικά με την σημαντικότητα των χαρακτηριστικών είναι λογικό που ο τρόπος πληρωμής 
...
κοστίζει η επισκευή. Παρατηρούμε ότι αυτό είναι σημαντικότερος παράγωντας απόφασης στις
κατηγορίες με μεγαλύτερο εύρος αξιών.
Για της μοτοσυκλέτες είναι λογικό 
τα πιο σημαντικά χαρακτηριστικά να είναι ο κύβισμος και η ηλικία του οδηγού αφού
...
ίδια ασφαλιστική πολιτική δεν παίζει πολύ σημαντικό ρόλο στην τελική τιμή 
...
δημιουργία ενός virtual environment ωστέ να εγκατασταθούν εκεί η βιβλιοθήκες της python
