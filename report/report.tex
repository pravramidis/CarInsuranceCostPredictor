...
\begin{figure}
    ...
    \end{center}
    \caption{Μοντέλο XGBoost που εκπαιδεύθηκε στο σύνολο των δεδομένων ξεχωριστή αξιολόγηση}  
...
\begin{figure}
    ...
    \end{center}
    \caption{Μοντέλο Random Forest που εκπαιδεύθηκε στο σύνολο των δεδομένων ξεχωριστή αξιολόγηση}  
...
\begin{figure}
    ...
    \end{center}
    \caption{Μοντέλο XGBoost που εκπαιδεύθηκε ξεχωριστά για κάθε κατηγορία}  
...
\begin{figure}
    ...
    \end{center}
    \caption{Μοντέλο Random Forest που εκπαιδεύθηκε ξεχωριστά για κάθε κατηγορία}  
...
\begin{figure}
    ...
    \end{center}
    \caption{Μοντέλο Νευρωνικού δικτύου που εκπαιδεύθηκε ξεχωριστά για κάθε κατηγορία}  
