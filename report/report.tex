...
Όσον αφορά την αρχιτεκρονική και την λειτουργεία του νευρωνικού,το δίκτυο χρησιμοποιεί ενσωματώσεις (embeddings) για τα κατηγορικά χαρακτηριστικά, μετατρέποντάς τα σε αριθμητική μορφή βάσει συγκεκριμένου μεγέθους ενσωμάτωσης.
Τα αριθμητικά χαρακτηριστικά και οι ενσωματώσεις των κατηγορικών χαρακτηριστικών συνδυάζονται σε ένα ενιαίο σύνολο εισόδων. Το δίκτυο αποτελείται από πολλά πλήρως συνδεδεμένα στρώματα με διαφορετικό αριθμό μονάδων, μειώνοντας σταδιακά τους νευρώνες,
ενώ χρησιμοποιείται στρώμα dropout (τιμή 0.2) για την τυχαία απενεργοποίηση ορισμένων νευρώνων, προλαμβάνοντας την υπερπροσαρμογή.
...
είναι το πιο σημαντικό χαρακτηριστικό στις 3 απο τις 4 κατηγορίες αφού αν πλήρωνεις
για όλο τον χρόνο η τιμή είναι λίγο μικρότερη. Για της μοτοσυκλέτες είναι λογικό 
...
Για τα βανάκια είναι λογικό ότι πιο σημαντικός παράγωντας είναι η αξία τους και η περιοχή 
τους γιατί υπάρχει μεγάλο εύρος αξίας για ένα βανάκι και επισής τα βανάκια για χρήση στην πόλη 
έχουν πολύ διαφορετικό ρίσκο απο αυτά σε ένα χωριό. 

Για τα επιβατικά αυτοκίνητα σηματνικότεροι παράγωντες είναι
η ηλικία του αυτοκινήτου, η αξία του και απο πού αγόρασε την ασφάλεια. Τα παλαιότερα αυτοκίνητα
είναι πιο πιθανό να έχουν βλάβες, η αξία των επιβατικών αυτοκινήτων έχει μεγάλο εύρος τιμών
και αν η ασφάλεια αγοράστικέ κατευθείαν απο την εταιρία είναι πιο φθηνη απο να αγοράστηκε απο 
τρίτους


Για τα αγροτικά οχήματα
το πιο σημάντικό είναι απο που αγοράστηκε η ασφάλεια και το ιστορικό ατυχημάτων της πολιτικής.
