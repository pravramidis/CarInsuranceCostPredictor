...
\begin{figure}
    ...
    \end{center}
    \caption{Premium και τύπος οχήματος} 
    \label{fig:Type_risk}   
\end{figure}
...
η ημερομηνία έναρξης συμβολαίου ή τελευταίας ανανέωσης συμβολαίου μείνει καινή 
θα συμπληρωθεί η τρέχουσα ημερομηνία. 
Σε περίπτωση που η ημερομηνία επόμενης ανανέωσης συμβολαίου μείνει 
καινή θα συμπληρωθεί η  ημερομηνία ένα χρόνο μετά απο την ημερομηνία τελευταίας ανανέωσης.
